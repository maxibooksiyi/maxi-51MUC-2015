...
{
	GUI_box((8*(x+1)),(8*(y+1)),(8*(x+2)),(8*(y+2)),0x07ff);	
}
...
void Init_SNAKE(void)   
{
	...
	//***********绘制游戏界面********************//
   GUI_clearscreen(0x07ff);//清屏
	GUI_box(0,200,175,219,0x07ff);
	//GUI_sprintf_HZ(0, 0, 0x07ff,0x001f);//显示预定义汉字字符串
	GUI_rectangle(8-1,8-1,165+1,210+1,0xaa);//绘制一个矩形框, 0-127
	GUI_sprintf_string(0,8,"SCORE",0x8b00,0xBE5F);
	GUI_sprintf_chartodec(0,24,Snake.Score,0xf800,0xBE5F);
 	GUI_sprintf_string(0,81,"LEVEL",0x8b00,0xBE5F);
	GUI_sprintf_chartodec(0,107,Snake.Level,0xf800,0xBE5F);
...
void Run_SNAKE(void)
{
	...
	if(Snake.X[Snake.Long-1]==Food.X&&Snake.Y[Snake.Long-1]==Food.Y)//
	{
		...
		Snake.Score+=10;
		GUI_sprintf_chartodec(100,24,Snake.Score,0xcc88,0xBE5F);
		Food.Yes=1;  //食物标志置1
	}
	/////////////////////////////////////////////////////////////////
